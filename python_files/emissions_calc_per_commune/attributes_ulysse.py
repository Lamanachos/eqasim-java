...
insee = 123456789
sc_folder = "\\simulation_output\\75005_drz_res"
basecase = False
basecase_name = "basecase"
basecase_scenario = "\\simulation_output\\75005_drz_res"
...
ms_file = "MS_&_ATT\\MS\\"
shapefile_commune_for_ms_and_att = origin_of_the_project + "gis" + "\\" +str(insee)+"\\"+str(insee)+".shp"
...
def build_attributes(basecase=False,sc_name=None,sc_folder=None,insee_par=None,every_commune = False):
    ...
    basecase_name = "basecase"
    basecase_scenario = r"C:\Users\ulysse.marcandella\Desktop\eqasim-java-pr\simulation_output\75005_drz_res"
    #split_network
    network_file = sc_folder+"\\output_network.xml.gz"
    #split_emissions
    events_to_keep = ["warmEmissionEvent","coldEmissionEvent"]
