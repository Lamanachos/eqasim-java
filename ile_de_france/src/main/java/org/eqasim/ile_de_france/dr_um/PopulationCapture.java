...
public class PopulationCapture {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String plansOutputFile = "./ile_de_france/scenarios"  + scenarioID + strategyID + "/ile_de_france_population_1p.xml.gz";
        String outputFile_ResidentsReader = "./ile_de_france/scenarios" + scenarioID + strategyID + "/personTestIDsList_1p.txt";
