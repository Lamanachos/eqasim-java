...
//BYIN: this is for specific test of driving restriction scenario with small size of population; it is used to test : only consider the population who live outside paris (the restriction zone) but work in paris by driving the car
...
public class PopulationCapture {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String plansOutputFile = "./ile_de_france/scenarios"  + scenarioID + strategyID + "/ile_de_france_population_test_100p.xml.gz";
        String outputFile_ResidentsReader = "./ile_de_france/scenarios" + scenarioID + strategyID + "/personTestIDsList_100p.txt";
       ...
       // for internal links
        ...
        population.getPersons().values().removeIf(person -> !personSampleIDsList.contains(person.getId().toString()));
